...
<nav>
	<div class="nav-wrapper grey lighten-2">
		...
		<ul class="right hide-on-med-and-down">
			<li><a href="sesionAdmin.php" class="black-text" title="Log out"><i class="material-icons right">account_circle</i>Back</a></li>
		</ul>
	</div>
</nav>
...
<header class="container col s12 m8 l6 offset-l3 offset-m2">
	<div class="card grey lighten-2">
		<div class="card-content black-text">
			<span class="card-title center">Teachers</span>
		</div>
	</div>
</header>
				...
				<table>
					...
					<tbody>
						...
						while ($valores = mysqli_fetch_array($query)) {
							...
							echo '<td>'.$valores[$pwd].'</td>';
							echo '<td>
							<form method="post" action="groupList.php">
							<button class="right btn waves-effect waves-light-blue blue" type="submit" name="id" value="'.$valores[$ID].'">Groups</button>
							</form>
							</td>';
							
							echo '<td>
							<form method="post" action="teacherUpdate.php">
							<button class="right waves-effect waves-light-green btn green" type="submit" name="id" value="'.$valores[$ID].'">Edit</button>
							</form>
							</td>';
							
							echo '<td>
							<form method="post" action="TeacherDelete.php">
							<button class="right waves-effect waves-light-red btn red" type="submit" name="id" value="'.$valores[$ID].'">Delete</button>
							</form>
							</td>';
